...
import { JhipsterSampleApplication5CoreModule } from 'app/core';
...
import { JhipsterSampleApplication5AccountModule } from './account/account.module';
...
@NgModule({
    imports: [
        ...
        JhipsterSampleApplication5AccountModule,
